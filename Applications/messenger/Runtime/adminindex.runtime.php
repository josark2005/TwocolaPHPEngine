<?php $TITLE='管理' ?><?php $level='Lv.255 黑管' ?><?php $head_img='/Applications/messenger/View/public/static/headimg.png' ?><!DOCTYPE html>
<html lang="zh-cn">
  <head>
    <meta charset="utf-8">
...
<link rel='stylesheet' href='/Applications/messenger/View/admin/css/index.css'>
...
<div class="container">
  ...
  <div class="am-container am-g">
    ...
    <div class="am-u-sm-12 am-u-md-9 side-right">
      ...
      <hr />
      <button class="am-btn am-btn-primary am-radius" id='shop_check' onclick="location.href='/messenger/admin/shop_check.tpl'">店铺申请审批 lv.10+</button>
