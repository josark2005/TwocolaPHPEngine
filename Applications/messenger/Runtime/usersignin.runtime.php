<?php $TITLE='登录' ?><?php $url_signin='/messenger/user/index' ?><!DOCTYPE html>
<html lang="zh-cn">
  <head>
    <meta charset="utf-8">
...
<link rel='stylesheet' href='/Applications/messenger/View/user/css/signin.css'><script src='/Applications/messenger/View/user/js/signin.js'></script>
<script language="javascript">
  <?php if(empty($_GET['jumpfrom'])): ?>
  var url_signin = "<?php if(isset($url_signin)){echo ($url_signin);} ?>";
  <?php else: ?>
  var url_signin = "<?php if(isset($_GET['jumpfrom'])){echo ($_GET['jumpfrom']);} ?>";
  <?php endif; ?>
  var url_api_signin = "/messenger/user/signin.tpl?app_type=api";
</script>
  <script language="javascript">
    $(function(){
  ...
  <div class="curtain container">
    <div class="am-container am-g">
      <div class="am-u-md-7 am-show-md-up">
        <img class="am-center am-img-responsive am-animation-fade am-center" height="230px" width="230px" src="/Applications/messenger/View/user/img/house.png">
      </div>
      <div class="am-u-md-5 am-u-sm-12 am-animation-slide-bottom curtain-panel-delay">
        
        <div class="am-panel am-panel-primary">
  				<div class="am-panel-hd">
  					<h2 class="am-panel-title am-text-center">登录<?php echo @APP_NAME; ?>帐号</h2>
  				</div>
  				<div class="am-panel-bd">
						...
						<div class="am-g">
							<div class="am-u-lg-6 am-u-sm-7">
								<strong><a href="/messenger/user/forget_password.tpl" tabindex="-1">忘记密码?</a></strong>
							</div>
                ...
                <buttom class="am-btn am-btn-success am-radius" onclick="signin();" tabindex="3">登录 <i class="am-icon am-icon-hand-spock-o"></i></buttom>
  				...
  				<div class="am-panel-footer">
  					<small>*为了您的账户安全，请确认当前是<?php echo @APP_NAME; ?>官网。</small>
  				</div>
  			</div>
      ...
      <div class="am-u-sm-12">
        <div class="am-alert alert-radius am-alert-warning am-animation-slide-bottom am-text-center am-show-md-up am-animation-delay-1" data-am-alert>
          还没有账户？<a href="/messenger/user/signup.tpl?from=twocola&id=0" tabindex="-1">点此注册</a>！
        </div>
      </div>
    </div>
  </div>
